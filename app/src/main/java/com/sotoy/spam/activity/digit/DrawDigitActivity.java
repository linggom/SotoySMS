...
package com.sotoy.spam.activity.digit;
...
public class DrawDigitActivity extends AppCompatActivity implements View.OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_draw_digit);

		boolean ret = mDetector.setupDigitDetector(this);
		if( !ret ) {
